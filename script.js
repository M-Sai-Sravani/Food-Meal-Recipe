            ...
            if (data.meals) {
                ...
                <div class = "meal-item   " data-id="${meal.idMeal}">
                    ...
                    <div class = "meal-name justify-content-center mb-2">
                       ...
                       <a href = "#" class = "detail-btn btn btn-info text-light">View Details</a>
                       <input type="button" onclick="addFav(this); openPopup()" value="Favourite" class="btn btn-info text-light" id="${meal.idMeal}" >
