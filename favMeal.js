              ...
              html += `
                        <div class = "meal-item  " data-id="${meal.idMeal}">
                            <div class = "meal-img p-3 ">
                                <img  src = "${meal.strMealThumb}" class="img-fluid rounded-circle"  alt = "food">
                            </div>
                            <div class = "meal-name justify-content-center mb-2">
                               ...
                               <a href = "#" class = "detail-btn btn btn-outline-primary">View Details</a>
                               <input type="button" onclick="removeFav(this); openPopup()" value="Remove" class="btn btn-outline-primary" id="${meal.idMeal}" >
...
// ***********************  Show A alert item is succesfully remove from your cart  ****************
